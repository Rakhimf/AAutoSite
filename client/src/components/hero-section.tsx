        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              ...
              <span className="text-brand-blue">Intelligent Automation</span>
            </h1>
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              Leading UK RPA consultancy specializing in UiPath solutions. Boost
              productivity, reduce costs, and eliminate manual processes with our
              proven automation expertise.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <Link href="/contact">
                <Button className="bg-brand-blue hover:bg-blue-700 text-white px-8 py-3 text-lg font-semibold">
              ...
              <Link href="/#roi-calculator">
                <Button
                  variant="outline"
                  className="border-2 border-brand-blue text-brand-blue hover:bg-brand-blue hover:text-white px-8 py-3 text-lg font-semibold"
                >
