            ...
            <div className="animate-slideInLeft">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="text-center p-4 bg-white rounded-lg shadow-sm">
                  <div className="text-2xl font-bold text-brand-blue">90%</div>
            ...
            <div className="animate-slideInRight">
              <div className="relative">
                <img 
                  ...
                  alt="Robot working alongside humans in an office environment representing RPA"
                  className="rounded-xl shadow-2xl w-full"
                />
                <div className="absolute -top-4 -left-4 bg-brand-blue rounded-lg shadow-lg p-3 text-white">
                  <div className="flex items-center space-x-2">
                    <Bot className="w-5 h-5" />
                    <span className="text-sm font-medium">RPA Guide</span>
                  </div>
                </div>
              </div>
            </div>
